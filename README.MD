...
## Containerization
    ...
    Everything is included to create a container using docker, including the dockerfile. Use the following commands in the root directiory of the API. (That is, where requirements.txt and this README are.)
